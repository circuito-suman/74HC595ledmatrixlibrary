...
private:
  const char *apSSID = "LEDMATRIX";      // AP SSID
  const char *apPassword = "suman saha"; // AP Password
  bool isInAPMode;                       // Current mode (true AP, false = STA)
  int lastButtonState;                   // Debouncing
  int buttonPin = 0;                     // D3 (GPIO0)
           // For ISR access
  WiFiUDP UDPServer;
